...
import { Search, ShoppingBag, User, Menu, X, LogIn, PawPrint } from 'lucide-react'
          ...
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <Link href="/" className="flex items-center gap-2">
              <div className="flex items-center gap-1.5">
                <PawPrint className="h-6 w-6 text-[hsl(171,45%,38%)]" strokeWidth={2} />
            ...
            <div className="flex items-center gap-1">
              ...
              >
                ...
                {itemCount > 0 && (
                  <span className="absolute top-0.5 right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-[hsl(171,45%,38%)] text-[10px] font-bold text-white">
                    {itemCount}
                  </span>
                )}
              </button>
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          >
            <div className="flex items-center justify-between p-4 border-b">
              <div className="flex items-center gap-1.5">
                <PawPrint className="h-5 w-5 text-[hsl(171,45%,38%)]" strokeWidth={2} />
                <span className="font-heading text-lg font-bold">PawCo</span>
              </div>
              <button
